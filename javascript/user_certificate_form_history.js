...
const userList = document.querySelector('#user-list-view-english');
function rendervoterlist(user){
    ...
    tdname.textContent = user.data().English_name;
    ...
    tddetails.href="user_certificate_detail_english.php?id="+tdidnumbeer.innerHTML;

    tdedit.textContent = "Edit";
    tdedit.href="new_user_form_edit_section.php?ideng="+tdidnumbeer.innerHTML;
