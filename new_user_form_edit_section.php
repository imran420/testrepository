...
<body>
	...
	<div class="main_body">
		<div class="main_body_container">
				...
				<div class="recent_middle_container_flex">
					<div class="recent_middle_container_flex_left">
                        <table class="bangla_table">
                            ...
                            <tr>
                                <td>ID</td>
                                <td id="userIdeng"><?php echo $_GET['ideng'];?></td>
                            </tr>
                            <tr>
                                <td>Name</td>
                                <td><input type="text" id="English_name"/></td>
                            </tr>

                            <tr>
                                <td>Father's Name</td>
                                <td><input type="text" id="English_father_name"/></td>
                            </tr>

                            <tr>
                                <td>Mother's Name</td>
                                <td><input type="text" id="English_mother_name"/></td>
                            </tr>

                            <tr>
                                <td>Mobile Number</td>
                                <td><input type="text" id="English_mobile_number"/></td>
                            </tr>

                            <tr>
                                <td>Voter Id Card</td>
                                <td><input type="text" id="voter_id_number_eng" readonly/></td>
                            </tr>
                            ...
                            <tr>
                                <td>House Number</td>
                                <td><input type="text" id="English_house_number"/></td>
                            </tr>
                            <tr>
                                <td>Road Number</td>
                                <td><input type="text" id="English_road_number"/></td>
                            </tr>
                            <tr>
                                <td>Block Number</td>
                                <td><input type="text" id="English_block_number"/></td>
                            </tr>
                            <tr>
                                <td colspan="2" style='text-align:center;vertical-align:middle;background: -webkit-linear-gradient(#0ef1c3, #45a049); -webkit-background-clip: text; -webkit-text-fill-color: transparent;
                            ...
                            <tr>
                                <td>Village</td>
                                <td ><input type="text" id="English_village_name"/></td>
                            </tr>
                            <tr>
                                <td>District</td>
                                <td ><input type="text" id="English_district_name"/></td>
                            </tr>
                            <tr>
                                <td>Police Station</td>
                                <td ><input type="text" id="English_police_station"/></td>
                            </tr>
                            <tr>
                                <td>Post Office</td>
                                <td ><input type="text" id="English_post_office"/></td>
                            </tr>
                            <tr>
                                <td><button id="editbtneng" name="editbtneng">Done</button></td>
                            </tr>
                        </table>
					</div>
				</div>
            ...
            <script type="text/javascript" src="javascript/edit_recent_file.js"></script>
