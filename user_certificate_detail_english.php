...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/user_detail_middle.css">
	...
	<div class="main_body">
		<div class="main_body_container">
			...
			<div class="main_body_container_field">
				<p>User Detail</p>
				<h2>Please check The Information Before Printing</h2>
				<div class="underline_middle">
					<span></span>
				</div>

				<div class="main_body_container_field_detail_element">
					...
					<div class="detail_element_print_button">
						<p>Select the form you want to print</p>
						<div class="underline">
							<span></span>
						</div>
					<div class="dashboard_flexbox_left_service_list_flexbox">
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="Succession_certificate.html">
							<img src="image/logo/certificate.png">
							<p>Succession certificate</p>
						</a>
					</div>
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="">
					...
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="death_certificate.html">
						<img src="image/logo/tombstone.png">
						<p>Death Certificate</p>
						</a>
					</div>
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="family_certificate.html">
					...
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						...
						<p>Parental consent card</p>
						</a>
					</div>
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="income_certificate.html">
					...
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="">
						<img src="image/logo/job.png">
						<p>Landless certificate</p>
						</a>
					</div>
					<div class="dashboard_flexbox_left_service_list_flexbox_element">
						<a href="remarriage_certificate.html">
						<img src="image/logo/tombstone.png">
                    ...
                    <script type="text/javascript" src="javascript/details_english.js"></script>
